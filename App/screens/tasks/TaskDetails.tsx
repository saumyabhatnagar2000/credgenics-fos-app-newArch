...
export default function TaskDetails({
    ...
    useEffect(() => {
        (async () => {
            ...
            try {
                const paymentTemplateResponse = await getPaymentTemplate(
                    authData
                );
    ...
    const validateDispositionForm = () => {
        ...
        if (
            continueIfOnline(reminderDate.length > 0 && checkedStep.length == 0)
        ) {
