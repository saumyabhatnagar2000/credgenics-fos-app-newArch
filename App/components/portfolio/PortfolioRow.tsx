...
import {StringCompare, getOnlyDistance, startCall} from '../../services/utils';
...
export default function PortfolioRow({
  ...
  const onCall = (number: string) => {
    ...
    const isManualAvailable = callingModes.includes(CallingModeTypes.manual);
      ...
      <View style={styles.rowCenter}>
        ...
        <TouchableOpacity
              ...
              <View style={{marginBottom: RFPercentage(1)}}>
                ...
                {companyType == CompanyType.credit_line ? (
                  <Typography
                    ...
                    {`Transactions: ${rowData?.number_of_transactions ?? 'NA'}`}
                  </Typography>
                ) : null}
                <Typography
          ...
          <View style={[styles.rowCenter, {justifyContent: 'space-between'}]}>
            <View
              style={[styles.rowCenter, {marginVertical: RFPercentage(0.5)}]}>
              <Icon
                style={{marginRight: 8}}
