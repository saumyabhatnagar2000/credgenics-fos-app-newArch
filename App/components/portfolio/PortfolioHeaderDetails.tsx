    ...
    const portfolioApisCalling = async () => {
        ...
        try {
            ...
            if (unattemptedLoansResponse?.success) {
                const unAttemptedLoans =
                    unattemptedLoansResponse?.data?.total_records;
