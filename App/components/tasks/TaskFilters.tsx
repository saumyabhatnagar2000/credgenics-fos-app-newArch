        ...
        <View style={{flexDirection: 'row', flex: 6}}>
          <View
            ...
            <FlatList
              ...
              ListEmptyComponent={
                <ErrorPlaceholder type="empty" message="No Filters found!" />
              }
              ...
              renderItem={({item}) => {
                let present =
                  !!selectedTaskFilterData?.[activeFilterTab]?.[item] ?? false;

                const onCheckboxClicked = () => {
                  if (activeFilterTab != TaskFilterType.scheduled_date)
                    checkBoxClicked(activeFilterTab, item);
                  else radioButtonClicked(activeFilterTab, item);
                };
